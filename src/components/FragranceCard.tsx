...
export const FragranceCard: React.FC<FragranceCardProps> = ({ product }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/5] w-full rounded-2xl overflow-hidden mb-4 border border-white/20 shadow-inner flex items-center justify-center bg-stone-50">
        ...
        <div className="relative font-serif font-extrabold text-white/20 text-6xl tracking-wider select-none pointer-events-none">
          N
        </div>
