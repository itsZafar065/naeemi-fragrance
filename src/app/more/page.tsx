...
export default function MoreMenuPage() {
  ...
  return (
    <div className="space-y-6 pb-12 max-w-md mx-auto animate-fadeIn">
      {/* 1. Header Profile block */}
      <div className="glass-panel p-5 rounded-[28px] border border-white/50 flex items-center gap-4">
        ...
        <div>
          <h2 className="font-extrabold text-stone-850 text-sm">Salman Khan</h2>
          <span className="text-[10px] bg-amber-600/10 text-amber-800 px-2 py-0.5 rounded-full font-bold uppercase tracking-wider">
      ...
      <div className="glass-panel rounded-[28px] overflow-hidden border border-white/50 divide-y divide-stone-200/40 text-xs">
        ...
        <Link 
          href="/admin" 
          className="p-4 hover:bg-white/40 flex items-center justify-between text-stone-700 font-bold transition-all"
        >
